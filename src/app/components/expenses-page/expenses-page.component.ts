...
export class ExpensesPageComponent{
  ...
  expenses: Expense[] = [
    ...
    { id: 4, tripId: 1, name: 'Expense 4', description: 'Description for Expense 4', amount: 400 },
    { id: 5, tripId: 1, name: 'Expense 5', description: 'Description for Expense 5', amount: 500 },
    { id: 6, tripId: 1, name: 'Expense 6', description: 'Description for Expense 6', amount: 600 },
